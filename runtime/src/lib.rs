...
impl nfttest::Trait for Runtime {
    type Event = Event;
}

impl nftregistry::Trait for Runtime {
    type Event = Event;
}
...
construct_runtime!(
		...
		UncheckedExtrinsic = UncheckedExtrinsic
	{
        ...
        Nfttest: nfttest::{Module, Call, Storage, Event<T>},
        NftRegistry: nftregistry::{Module, Call, Storage, Event<T>},
